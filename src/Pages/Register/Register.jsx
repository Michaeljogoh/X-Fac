...
const Register = () => {
 ...
 let navigate = useNavigate()
  ...
  const handleSubmit = async (e) =>{
    ...
    try {
     await axios.post(`${baseURL}/api/v1/user/register`, newUser , {headers:{"Content-Type":"application/json"}})
     navigate('/login')
    } catch (error) {
      console.log(error)
    }
                        ...
                        <form class="user" onSubmit={handleSubmit}>
                            <div class="form-group mb-3">
                                <input type="text" class="form-control form-control-user"
                                    id="exampleInputEmail"  onChange={(e) => setUsername(e.target.value)}    aria-describedby="emailHelp"
